var size = 0;
var placement = 'point';
function categories_KemiringanLereng_6(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case '>40%':
...
var style_KemiringanLereng_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_KemiringanLereng_6(feature, value, size, resolution, labelText,
